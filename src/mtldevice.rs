...
impl MTLDevice {
    ...
    pub fn newLibraryWithData<'a>(&self, data: &dispatchr::data::Unmanaged, pool: &'a ActiveAutoreleasePool) -> Result<StrongMutCell<MTLLibrary>,AutoreleasedCell<'a, NSError>> {
        unsafe {
            //assume_nonmut_perform: see comment above
